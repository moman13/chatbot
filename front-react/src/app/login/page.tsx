      ...
      <section className="min-h-screen flex items-center justify-center py-12 px-6">
        <div className="max-w-md w-full space-y-8">
          <div className="text-center">
            ...
            <p className="mt-2 text-slate-300">Sign in to your AqlBot account</p>
          </div>
          ...
          <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
            ...
            <div className="text-center">
              <p className="text-sm text-slate-400">
                ...
                <Link href="/register" className="text-primary hover:underline font-medium ml-1">Sign up for free</Link>
              </p>
            </div>
          </form>
            ...
            <div className="bg-slate-800 rounded-xl p-4 border border-slate-700">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-slate-400">Your data is protected with enterprise-grade security</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-slate-800 rounded-xl p-4 border border-slate-700">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-slate-400">Get back to managing your chatbots in seconds</p>
                </div>
              </div>
            </div>
          </div>
